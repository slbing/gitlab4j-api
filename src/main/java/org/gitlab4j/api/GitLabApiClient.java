...
/**
 * This class utilizes the Jersey client package to communicate with a GitLab
 * API endpoint.
 */
public class GitLabApiClient {
  ...
  /**
   * Construct an instance to communicate with a GitLab API server using the
   * specified GitLab API version, server URL, private token, and secret token.
   *
   * @param apiVersion
   *          the ApiVersion specifying which version of the API to use
   * @param hostUrl
   *          the URL to the GitLab API server
   * @param privateToken
   *          the private token to authenticate with
   */
  public GitLabApiClient(ApiVersion apiVersion, String hostUrl,
      String privateToken) {
  ...
  /**
   * Construct an instance to communicate with a GitLab API server using the
   * specified GitLab API version, server URL, auth token type, private or
   ...
   */
  public GitLabApiClient(ApiVersion apiVersion, String hostUrl,
      TokenType tokenType, String authToken) {
    this(apiVersion, hostUrl, tokenType, authToken, null);
  }
  
  /**
   * Construct an instance to communicate with a GitLab API server using GitLab
   * API version 4, and the specified server URL, private token, and secret
   * token.
   *
   * @param hostUrl
   *          the URL to the GitLab API server
   ...
   *          the token to authenticate with
   */
  public GitLabApiClient(String hostUrl, TokenType tokenType,
      String authToken) {
   ...
   */
  public GitLabApiClient(ApiVersion apiVersion, String hostUrl,
      String privateToken, String secretToken) {
   ...
   */
  public GitLabApiClient(ApiVersion apiVersion, String hostUrl,
      TokenType tokenType, String authToken, String secretToken) {
  ...
  /**
   * Construct an instance to communicate with a GitLab API server using GitLab
   * API version 4, and the specified server URL and private token.
   *
   * @param hostUrl
   *          the URL to the GitLab API server
   * @param privateToken
  ...
  /**
   * Construct an instance to communicate with a GitLab API server using the
   * specified GitLab API version, server URL and private token.
   *
   * @param apiVersion
   *          the ApiVersion specifying which version of the API to use
   * @param hostUrl
  ...
  public GitLabApiClient(ApiVersion apiVersion, String hostUrl,
    ...
    this.hostUrl = (hostUrl.endsWith("/") ? hostUrl.replaceAll("/$", "")
        : hostUrl);
    ...
    if (clientConfigProperties != null) {
      ...
      for (Map.Entry<String,Object> propertyEntry : clientConfigProperties
          .entrySet()) {
  ...
  void enableRequestResponseLogging(Logger logger, Level level) {
    ...
    LoggingFeature loggingFeature = new LoggingFeature(logger, level,
  ...
  /**
   * Construct a REST URL with the specified path arguments using Gitlab base
   * url.
   *
   * @param pathArgs
   *          variable list of arguments used to build the URI
  ...
  /**
   * Validates the secret token (X-GitLab-Token) header against the expected
   * secret token, returns true if valid, otherwise returns false.
   *
   * @param response
   *          the Response instance sent from the GitLab server
   * @return true if the response's secret token is valid, otherwise returns
   *         false
   */
  ...
  /**
   * Perform an HTTP GET call with the specified query parameters and path
   * objects, returning a ClientResponse instance with the data returned from
   * the endpoint.
   *
   * @param queryParams
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response get(MultivaluedMap<String,String> queryParams,
  ...
  /**
   * Perform an HTTP GET call with the specified query parameters and URL,
   * returning a ClientResponse instance with the data returned from the
   * endpoint.
   *
   * @param queryParams
   *          multivalue map of request parameters
   ...
   *          multivalue map of request parameters
   * @param accepts
   *          if non-empty will set the Accepts header to this value
   * @param pathArgs
   *          variable list of arguments used to build the URI
   * @return a ClientResponse instance with the data returned from the endpoint
   * @throws IOException
   *           if an error occurs while constructing the URL
   */
  protected Response getWithAccepts(MultivaluedMap<String,String> queryParams,
      String accepts, Object... pathArgs) throws IOException {
    URL url = getApiUrl(pathArgs);
   ...
   */
  protected Response getWithAccepts(MultivaluedMap<String,String> queryParams,
      URL url, String accepts) {
    return (invocation(url, queryParams, accepts).get());
  }
  
  /**
   * Perform an HTTP HEAD call with the specified query parameters and path
   * objects, returning a ClientResponse instance with the data returned from
   * the endpoint.
   *
   * @param queryParams
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response head(MultivaluedMap<String,String> queryParams,
      Object... pathArgs) throws IOException {
    URL url = getApiUrl(pathArgs);
  ...
  /**
   * Perform an HTTP HEAD call with the specified query parameters and URL,
   * returning a ClientResponse instance with the data returned from the
   * endpoint.
   *
   * @param queryParams
  ...
  /**
   * Perform an HTTP POST call with the specified form data and path objects,
   * returning a ClientResponse instance with the data returned from the
   * endpoint.
   *
   * @param formData
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response post(MultivaluedMap<String,String> queryParams,
      Object... pathArgs) throws IOException {
    URL url = getApiUrl(pathArgs);
  ...
  /**
   * Perform an HTTP POST call with the specified form data and URL, returning a
  ...
  protected Response post(Form formData, URL url) {
    if (formData instanceof GitLabApiForm)
      return (invocation(url, null).post(Entity.entity(formData.asMap(),
          MediaType.APPLICATION_FORM_URLENCODED_TYPE)));
    else return (invocation(url, null).post(
        Entity.entity(formData, MediaType.APPLICATION_FORM_URLENCODED_TYPE)));
  }
   ...
   *
   * @param queryParams
   *          multivalue map of request parametersformData the Form containing
  ...
  /**
   * Perform an HTTP POST call with the specified payload object and URL,
   * returning a ClientResponse instance with the data returned from the
   * endpoint.
   *
   * @param payload
   *          the object instance that will be serialized to JSON and used as
   *          the POST data
   * @param pathArgs
   *          variable list of arguments used to build the URI
   * @return a ClientResponse instance with the data returned from the endpoint
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response post(Object payload, Object... pathArgs)
      throws IOException {
    URL url = getApiUrl(pathArgs);
  ...
  /**
   * Perform an HTTP POST call with the specified StreamingOutput, MediaType,
   * and path objects, returning a ClientResponse instance with the data
   * returned from the endpoint.
   *
   * @param stream
   *          the StreamingOutput instance that contains the POST data
   * @param mediaType
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response post(StreamingOutput stream, String mediaType,
      Object... pathArgs) throws IOException {
    URL url = getApiUrl(pathArgs);
  ...
  /**
   * Perform a file upload as part of the , returning a ClientResponse instance
   * with the data returned from the endpoint.
   *
   * @param name
   *          the name for the form field that contains the file name
   * @param fileToUpload
   *          a File instance pointing to the file to upload
   * @param mediaTypeString
   *          the content-type of the uploaded file, if null will be determined
   *          from fileToUpload
   * @param pathArgs
   *          variable list of arguments used to build the URI
   * @return a ClientResponse instance with the data returned from the endpoint
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response upload(String name, File fileToUpload,
      String mediaTypeString, Object... pathArgs) throws IOException {
    URL url = getApiUrl(pathArgs);
    return (upload(name, fileToUpload, mediaTypeString, url));
  }
  
  /**
   * Perform a file upload using multipart/form-data, returning a ClientResponse
   ...
   */
  protected Response upload(String name, File fileToUpload,
      String mediaTypeString, URL url) throws IOException {
    
    MediaType mediaType = (mediaTypeString != null
  ...
  /**
   * Perform an HTTP PUT call with the specified form data and path objects,
   * returning a ClientResponse instance with the data returned from the
   * endpoint.
   *
   * @param queryParams
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response put(MultivaluedMap<String,String> queryParams,
      Object... pathArgs) throws IOException {
    URL url = getApiUrl(pathArgs);
  ...
  /**
   * Perform an HTTP PUT call with the specified form data and URL, returning a
   * ClientResponse instance with the data returned from the endpoint.
   *
   * @param queryParams
   *          multivalue map of request parameters
  ...
  protected Response put(MultivaluedMap<String,String> queryParams, URL url) {
    if (queryParams == null || queryParams.isEmpty()) {
      ...
      return (invocation(url, null).put(Entity.entity(queryParams,
          MediaType.APPLICATION_FORM_URLENCODED_TYPE)));
    }
  }
  ...
  protected Response put(Form formData, URL url) {
    if (formData instanceof GitLabApiForm)
      return (invocation(url, null).put(Entity.entity(formData.asMap(),
          MediaType.APPLICATION_FORM_URLENCODED_TYPE)));
    else return (invocation(url, null).put(
        Entity.entity(formData, MediaType.APPLICATION_FORM_URLENCODED_TYPE)));
  }
  
  /**
   * Perform an HTTP DELETE call with the specified form data and path objects,
   * returning a Response instance with the data returned from the endpoint.
   *
   * @param queryParams
   *          multivalue map of request parameters
   * @param pathArgs
   ...
   *           if an error occurs while constructing the URL
   */
  protected Response delete(MultivaluedMap<String,String> queryParams,
      Object... pathArgs) throws IOException {
  ...
  protected Invocation.Builder invocation(URL url,
      MultivaluedMap<String,String> queryParams) {
    return (invocation(url, queryParams, MediaType.APPLICATION_JSON));
  }
  
  protected Client createApiClient() {
    // modify by kim force user Jersey, for conflict with Cxf
  ...
  protected Invocation.Builder invocation(URL url,
      MultivaluedMap<String,String> queryParams, String accept) {
    ...
    String authHeader = (tokenType == TokenType.ACCESS ? AUTHORIZATION_HEADER
        : PRIVATE_TOKEN_HEADER);
    String authValue = (tokenType == TokenType.ACCESS ? "Bearer " + authToken
        : authToken);
   ...
   *
   * @return true if successful at setting up to ignore certificate errors,
   *         otherwise returns false.
   */
