...
/**
 * This class is provides a simplified interface to a GitLab API server, and
 * divides the API up into a separate API class for each concern.
 */
public class GitLabApi {
  ...
  private static final Map<Optional<?>,GitLabApiException> optionalExceptionMap = Collections
      .synchronizedMap(new WeakHashMap<Optional<?>,GitLabApiException>());
  ...
  /**
   * Create a new GitLabApi instance that is logically a duplicate of this
   * instance, with the exception off sudo state.
   *
   * @return a new GitLabApi instance that is logically a duplicate of this
   *         instance, with the exception off sudo state.
   */
  public final GitLabApi duplicate() {
    ...
    GitLabApi gitLabApi = new GitLabApi(apiVersion, gitLabServerUrl,
        getTokenType(), getAuthToken(), getSecretToken(),
  ...
  /**
   * <p>
   * Logs into GitLab using OAuth2 with the provided {@code username} and
   * {@code password}, and creates a new {@code GitLabApi} instance using
   ...
   *          GitLab URL
   * @param username
   *          user name for which private token should be obtained
   * @param password
   *          password for a given {@code username}
   ...
   * @deprecated As of release 4.8.7, replaced by
   *             {@link #oauth2Login(String, String, CharSequence)}, will be
   *             removed in 4.9.0
   */
  @Deprecated
  public static GitLabApi oauth2Login(String url, String username,
      String password) throws GitLabApiException {
    return (GitLabApi.oauth2Login(ApiVersion.V4, url, username, password, null,
        null, false));
  }
   ...
   *          user name for which private token should be obtained
   * @param password
   *          a CharSequence containing the password for a given
   *          {@code username}
   * @return new {@code GitLabApi} instance configured for a user-specific token
   * @throws GitLabApiException
   *           GitLabApiException if any exception occurs during execution
   */
  public static GitLabApi oauth2Login(String url, String username,
      CharSequence password) throws GitLabApiException {
    return (GitLabApi.oauth2Login(ApiVersion.V4, url, username, password, null,
        null, false));
  }
   ...
   *          user name for which private token should be obtained
   * @param password
   *          a char array holding the password for a given {@code username}
   * @return new {@code GitLabApi} instance configured for a user-specific token
   * @throws GitLabApiException
   *           GitLabApiException if any exception occurs during execution
   */
  public static GitLabApi oauth2Login(String url, String username,
      char[] password) throws GitLabApiException {
    
    try (SecretString secretPassword = new SecretString(password)) {
      return (GitLabApi.oauth2Login(ApiVersion.V4, url, username,
          secretPassword, null, null, false));
    }
  }
   ...
   *          if true will set up the Jersey system ignore SSL certificate
   *          errors
   * @return new {@code GitLabApi} instance configured for a user-specific token
   * @throws GitLabApiException
   *           GitLabApiException if any exception occurs during execution
   * @deprecated As of release 4.8.7, replaced by
   *             {@link #oauth2Login(String, String, CharSequence, boolean)},
   *             will be removed in 4.9.0
   */
  @Deprecated
  public static GitLabApi oauth2Login(String url, String username,
      String password, boolean ignoreCertificateErrors)
      throws GitLabApiException {
    return (GitLabApi.oauth2Login(ApiVersion.V4, url, username, password, null,
        null, ignoreCertificateErrors));
  }
   ...
   */
  public static GitLabApi oauth2Login(String url, String username,
      CharSequence password, boolean ignoreCertificateErrors)
      throws GitLabApiException {
    return (GitLabApi.oauth2Login(ApiVersion.V4, url, username, password, null,
        null, ignoreCertificateErrors));
  }
   ...
   */
  public static GitLabApi oauth2Login(String url, String username,
      char[] password, boolean ignoreCertificateErrors)
      throws GitLabApiException {
    
    try (SecretString secretPassword = new SecretString(password)) {
      return (GitLabApi.oauth2Login(ApiVersion.V4, url, username,
          secretPassword, null, null, ignoreCertificateErrors));
    }
  }
   ...
   *          Map instance with additional properties for the Jersey client
   *          connection
   * @param ignoreCertificateErrors
   *          if true will set up the Jersey system ignore SSL certificate
   *          errors
  ...
  @Deprecated
  public static GitLabApi oauth2Login(String url, String username,
      String password, String secretToken,
      Map<String,Object> clientConfigProperties,
      boolean ignoreCertificateErrors) throws GitLabApiException {
    return (GitLabApi.oauth2Login(ApiVersion.V4, url, username, password,
   ...
   */
  public static GitLabApi oauth2Login(String url, String username,
      CharSequence password, String secretToken,
      Map<String,Object> clientConfigProperties,
      boolean ignoreCertificateErrors) throws GitLabApiException {
    return (GitLabApi.oauth2Login(ApiVersion.V4, url, username, password,
        secretToken, clientConfigProperties, ignoreCertificateErrors));
   ...
   */
  public static GitLabApi oauth2Login(String url, String username,
      char[] password, String secretToken,
      Map<String,Object> clientConfigProperties,
      boolean ignoreCertificateErrors) throws GitLabApiException {
    
    try (SecretString secretPassword = new SecretString(password)) {
      return (GitLabApi.oauth2Login(ApiVersion.V4, url, username,
          secretPassword, secretToken, clientConfigProperties,
   ...
   *          GitLab URL
   * @param apiVersion
   *          the ApiVersion specifying which version of the API to use
   * @param username
   *          user name for which private token should be obtained
   * @param password
   *          a char array holding the password for a given {@code username}
   ...
   *           GitLabApiException if any exception occurs during execution
   */
  public static GitLabApi oauth2Login(ApiVersion apiVersion, String url,
      String username, char[] password, String secretToken,
      Map<String,Object> clientConfigProperties,
      boolean ignoreCertificateErrors) throws GitLabApiException {
   ...
   */
  public static GitLabApi oauth2Login(ApiVersion apiVersion, String url,
      String username, CharSequence password, String secretToken,
      Map<String,Object> clientConfigProperties,
      boolean ignoreCertificateErrors) throws GitLabApiException {
    ...
    GitLabApi gitLabApi = new GitLabApi(ApiVersion.OAUTH2_CLIENT, url,
        (String) null);
    ...
    try (Oauth2LoginStreamingOutput stream = new Oauth2LoginStreamingOutput(
        username, password)) {
      
      Response response = new Oauth2Api(gitLabApi).post(Response.Status.OK,
          stream, MediaType.APPLICATION_JSON, "oauth", "token");
      OauthTokenResponse oauthToken = response
          .readEntity(OauthTokenResponse.class);
      gitLabApi = new GitLabApi(apiVersion, url, TokenType.ACCESS,
          oauthToken.getAccessToken(), secretToken, clientConfigProperties);
      if (ignoreCertificateErrors) {
        gitLabApi.setIgnoreCertificateErrors(true);
      }
  ...
  /**
   * <p>
   * Logs into GitLab using provided {@code username} and {@code password}, and
   * creates a new {@code GitLabApi} instance using returned private token and
   * the specified GitLab API version.
   * </p>
   *
   * <strong>NOTE</strong>: For GitLab servers 10.2 and above this will utilize
   * OAUTH2 for login. For GitLab servers prior to 10.2, the Session API login
   * is utilized.
   *
   * @param apiVersion
   *          the ApiVersion specifying which version of the API to use
   ...
   */
  @Deprecated
  public static GitLabApi login(ApiVersion apiVersion, String url,
      String username, String password) throws GitLabApiException {
   ...
   * <p>
   * Logs into GitLab using provided {@code username} and {@code password}, and
   * creates a new {@code GitLabApi} instance using returned private token using
   ...
   */
  @Deprecated
  public static GitLabApi login(String url, String username, String password)
      throws GitLabApiException {
  ...
  @Deprecated
  public static GitLabApi login(ApiVersion apiVersion, String url,
      String username, String password, boolean ignoreCertificateErrors)
      throws GitLabApiException {
    ...
    try {
      ...
      if (gle.getHttpStatus() != Response.Status.NOT_FOUND.getStatusCode()) {
        ...
        gitLabApi = GitLabApi.oauth2Login(apiVersion, url, username, password,
            null, null, ignoreCertificateErrors);
      }
    }
   ...
   *             {@link #login(String, String, String)}, will be removed in
   *             4.9.0
   */
  @Deprecated
  public static GitLabApi create(String url, String username, String password)
      throws GitLabApiException {
  ...
  /**
   * <p>
   * If this instance was created with {@link #login(String, String, String)}
   * this method will return the Session instance returned by the GitLab API on
   * login, otherwise returns null.
   * </p>
   *
   * <strong>NOTE</strong>: For GitLab servers 10.2 and above this method will
   * always return null.
   *
   ...
   * using the specified GitLab API version.
   *
   * @param apiVersion
   *          the ApiVersion specifying which version of the API to use
   * @param hostUrl
   ...
   * @param tokenType
   *          the type of auth the token is for, PRIVATE or ACCESS
   * @param authToken
   *          the token to use for access to the API
   */
  public GitLabApi(ApiVersion apiVersion, String hostUrl, TokenType tokenType,
      String authToken) {
   ...
   *          the URL of the GitLab server
   * @param privateToken
   *          to private token to use for access to the API
   */
   ...
   *          the URL of the GitLab server
   * @param session
   *          the Session instance obtained by logining into the GitLab server
   */
  public GitLabApi(ApiVersion apiVersion, String hostUrl, Session session) {
    this(apiVersion, hostUrl, TokenType.PRIVATE, session.getPrivateToken(),
        null);
  ...
  /**
   * Constructs a GitLabApi instance set up to interact with the GitLab server
   * specified by GitLab API version.
   *
   * @param apiVersion
   *          the ApiVersion specifying which version of the API to use
   * @param hostUrl
  ...
  public GitLabApi(ApiVersion apiVersion, String hostUrl, String privateToken,
    ...
    this(apiVersion, hostUrl, TokenType.PRIVATE, privateToken, secretToken,
        clientConfigProperties);
  }
  ...
  public GitLabApi(ApiVersion apiVersion, String hostUrl, TokenType tokenType,
    ...
    apiClient = new GitLabApiClient(apiVersion, hostUrl, tokenType, authToken,
        secretToken, clientConfigProperties);
  }
  
  /**
   * Enable the logging of the requests to and the responses from the GitLab
   * server API using the GitLab4J shared Logger instance and Level.FINE as the
   * level.
   *
  ...
  /**
   * Enable the logging of the requests to and the responses from the GitLab
   * server API using the GitLab4J shared Logger instance.
   *
   * @param level
   *          the logging level (SEVERE, WARNING, INFO, CONFIG, FINE, FINER,
   *          FINEST)
   * @return this GitLabApi instance
   */
  ...
  /**
   * Sets up all future calls to the GitLab API to be done as another user
   * specified by sudoAsUsername. To revert back to normal non-sudo operation
   * you must call unsudo(), or pass null as the username.
   *
   * @param sudoAsUsername
   *          the username to sudo as, null will turn off sudo
   * @throws GitLabApiException
  ...
  public void sudo(String sudoAsUsername) throws GitLabApiException {
    ...
    // Get the User specified by username, if you are not an admin or the
    // username is not found, this will fail
  ...
  /**
   * Sets up all future calls to the GitLab API to be done as another user
   * specified by provided user ID. To revert back to normal non-sudo operation
   * you must call unsudo(), or pass null as the sudoAsId.
   *
   * @param sudoAsId
   *          the ID of the user to sudo as, null will turn off sudo
   * @throws GitLabApiException
   *           if any exception occurs
   */
  public void setSudoAsId(Integer sudoAsId) throws GitLabApiException {
    ...
    // Get the User specified by the sudoAsId, if you are not an admin or the
    // username is not found, this will fail
   ...
   *          the new default number per page for calls that return multiple
   *          item
   */
  ...
  /**
   * Return the GitLabApiClient associated with this instance. This is used by
   * all the sub API classes to communicate with the GitLab API.
   *
  ...
  /**
   * Returns true if the API is setup to ignore SSL certificate errors,
   * otherwise returns false.
   *
   * @return true if the API is setup to ignore SSL certificate errors,
   *         otherwise returns false
   */
  ...
  public Version getVersion() throws GitLabApiException {
    ...
    Response response = new VersionApi(this).get(Response.Status.OK, null,
        "version");
    return (response.readEntity(Version.class));
  }
  
  /**
   * Gets the AwardEmojiApi instance owned by this GitLabApi instance. The
   * AwardEmojiApi is used to perform all award emoji related API calls.
   *
  ...
  /**
   * Gets the CommitsApi instance owned by this GitLabApi instance. The
   * CommitsApi is used to perform all commit related API calls.
   *
  ...
  /**
   * Gets the DeployKeysApi instance owned by this GitLabApi instance. The
   * DeployKeysApi is used to perform all deploy key related API calls.
   *
   * @return the CommitsApi instance owned by this GitLabApi instance
   */
  ...
  /**
   * Gets the EpicsApi instance owned by this GitLabApi instance. The EpicsApi
   * is used to perform all Epics and Epic Issues related API calls.
   *
  ...
  /**
   * Gets the EventsApi instance owned by this GitLabApi instance. The EventsApi
   * is used to perform all events related API calls.
   *
  ...
  /**
   * Gets the GroupApi instance owned by this GitLabApi instance. The GroupApi
   * is used to perform all group related API calls.
   *
  ...
  /**
   * Gets the HealthCheckApi instance owned by this GitLabApi instance. The
   * HealthCheckApi is used to perform all admin level gitlab health monitoring.
   *
  ...
  /**
   * Gets the IssuesApi instance owned by this GitLabApi instance. The IssuesApi
   * is used to perform all iossue related API calls.
   *
   * @return the CommitsApi instance owned by this GitLabApi instance
   */
  ...
  /**
   * Gets the JobApi instance owned by this GitLabApi instance. The JobApi is
   * used to perform all jobs related API calls.
   *
  ...
  /**
   * Gets the LicensesApi instance owned by this GitLabApi instance. The
   * LicensesApi is used to perform all license related API calls.
   *
  ...
  /**
   * Gets the MarkdownApi instance owned by this GitLabApi instance. The
   * MarkdownApi is used to perform all markdown related API calls.
   *
  ...
  /**
   * Gets the MergeRequestApi instance owned by this GitLabApi instance. The
   * MergeRequestApi is used to perform all merge request related API calls.
   *
  ...
  /**
   * Gets the NamespaceApi instance owned by this GitLabApi instance. The
   * NamespaceApi is used to perform all namespace related API calls.
   *
  ...
  /**
   * Gets the NotesApi instance owned by this GitLabApi instance. The NotesApi
   * is used to perform all notes related API calls.
   *
  ...
  /**
   * Gets the PipelineApi instance owned by this GitLabApi instance. The
   * PipelineApi is used to perform all pipeline related API calls.
   *
  ...
  /**
   * Gets the ProjectApi instance owned by this GitLabApi instance. The
   * ProjectApi is used to perform all project related API calls.
   *
   ...
   * The ProtectedBranchesApi is used to perform all protection related actions
   * on a branch of a project.
   *
  ...
  /**
   * Gets the RepositoryApi instance owned by this GitLabApi instance. The
   * RepositoryApi is used to perform all repository related API calls.
   *
  ...
  /**
   * Gets the RepositoryFileApi instance owned by this GitLabApi instance. The
   * RepositoryFileApi is used to perform all repository files related API
   * calls.
   *
  ...
  /**
   * Gets the RunnersApi instance owned by this GitLabApi instance. The
   * RunnersApi is used to perform all Runner related API calls.
   *
  ...
  /**
   * Gets the ServicesApi instance owned by this GitLabApi instance. The
   * ServicesApi is used to perform all services related API calls.
   *
  ...
  /**
   * Gets the SessionApi instance owned by this GitLabApi instance. The
   * SessionApi is used to perform a login to the GitLab API.
   *
  ...
  /**
   * Gets the SystemHooksApi instance owned by this GitLabApi instance. All
   * methods require administrator authorization.
   *
  ...
  /**
   * Gets the TagsApi instance owned by this GitLabApi instance. The TagsApi is
   * used to perform all tag and release related API calls.
   *
  ...
  /**
   * Gets the UserApi instance owned by this GitLabApi instance. The UserApi is
   * used to perform all user related API calls.
   *
  ...
  /**
   * Create and return an Optional instance associated with a
   * GitLabApiException.
   *
   * @param <T>
   *          the type for the Optional parameter
   * @param glae
   *          the GitLabApiException that was the result of a call to the GitLab
   *          API
   * @return the created Optional instance
   */
  protected static final <T> Optional<T> createOptionalFromException(
      GitLabApiException glae) {
  ...
  /**
   * Get the exception associated with the provided Optional instance, or null
   * if no exception is associated with the Optional instance.
   *
   * @param optional
   *          the Optional instance to get the exception for
   * @return the exception associated with the provided Optional instance, or
   *         null if no exception is associated with the Optional instance
   */
  public static final GitLabApiException getOptionalException(
      Optional<?> optional) {
    return (optionalExceptionMap.get(optional));
  }
  
  /**
   * Return the Optional instances contained value, if present, otherwise throw
   * the exception that is associated with the Optional instance.
   *
   * @param <T>
   *          the type for the Optional parameter
   * @param optional
   *          the Optional instance to get the value for
   * @return the value of the Optional instance if no exception is associated
   *         with it
   * @throws GitLabApiException
  ...
  /**
   * Gets the SnippetsApi instance owned by this GitLabApi instance. The
   * SnippetsApi is used to perform all snippet related API calls.
   *
  ...
  /**
   * Gets the WikisApi instance owned by this GitLabApi instance. The WikisApi
   * is used to perform all wiki related API calls.
   *
